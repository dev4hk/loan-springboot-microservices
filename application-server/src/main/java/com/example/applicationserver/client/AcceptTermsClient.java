...
import com.example.applicationserver.client.fallback.AcceptTermsClientFallbackFactory;
...
@FeignClient(name = "accept-terms-server", fallbackFactory = AcceptTermsClientFallbackFactory.class, configuration = FeignConfig.class)
