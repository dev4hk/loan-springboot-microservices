...
//                        .pathMatchers("/loan/accept-terms/**").authenticated()
                                ...
                                .pathMatchers(HttpMethod.POST, JUDGEMENT.getUri()).hasAnyRole(MANAGER.getRole())
                                .pathMatchers(HttpMethod.PUT, JUDGEMENT.getUri()).hasAnyRole(MANAGER.getRole())
                                .pathMatchers(HttpMethod.DELETE, JUDGEMENT.getUri()).hasAnyRole(MANAGER.getRole())
